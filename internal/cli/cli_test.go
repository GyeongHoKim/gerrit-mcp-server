...
func TestEveryCommandReportsAGerritFailure(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"list-change-messages":       {status: http.StatusNotFound, want: "listing change messages on 12345"},
...
func readFixtures() map[string]string {
	return map[string]string{
		...
		"list-change-messages":       `[{"id":"m1","message":"Uploaded patch set 1.","date":"2026-07-30 09:00:00.000000000"}]`,
